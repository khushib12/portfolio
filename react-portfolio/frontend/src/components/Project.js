...
const Project = () => {
  return (
    <>
      ...
      <div className='mx-5'>
        <a href='https://github.com/khushib12' target='_blank' rel='noreferrer' className='bg-gray block shadow-lg uppercase border border-gray-500 rounded-lg text-center my-12 p-2 max-w-xs m-auto'>
